      ...
      <div className="card-body">
        ...
        <div className="card-actions">
          <Link className="w-full" to={`/post/details/${post._id}`}>
            <button className="btn px-6 w-full rounded-xl mt-3 bg-black border-black hover:border-[#28282B] hover:text-[#28282B] text-white uppercase transition-all hover:bg-white duration-300 hover:scale-105">
              View Details
            </button>
          </Link>
        </div>
